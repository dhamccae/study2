...
<title>WEB-INF/view/memberList.jsp</title>
<link rel="stylesheet"
...
<body>
	<div class="container">
		...
		<jsp:useBean id="memberSearch" class="com.study.member.vo.MemberSearch" />
		<jsp:setProperty property="*" name="memberSearch" />
				...
				<div>
					<ul class="pagination">
						<c:if test="${search.startPage >1 }">
							<li><a
								href="memberList.do?currentPage=${search.startPage -1 }"> <span
						...
						<c:if test="${search.endPage < search.totalPageCount}">
							<li><a
								href="memberList.do?currentPage=${search.endPage +1 }"> <span
